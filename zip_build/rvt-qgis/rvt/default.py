...
class DefaultValues:
    ...
    def __init__(self):
        ...
        # multiprocessing
        # in QGIS plugin multiprocessing is not yet supported -> multiproc_size_limit is unreachable high
        self.multiproc_size_limit = 10000000 * 10000000  # if arr size > multiproc_size_limit, it uses multiprocessing
